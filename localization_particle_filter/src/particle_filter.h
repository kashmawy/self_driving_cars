...
public:
	 ...
	 */
	Map::single_landmark_s getCorrespondingLandmark(LandmarkObs observation, Map landmarks);

	vector<LandmarkObs> transformObservations(Particle particle, vector<LandmarkObs> observations);
